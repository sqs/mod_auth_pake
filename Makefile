...
test_http_tcpcrypt_auth.o:
	gcc -g -Wall -Werror -lssl -std=c99 -I`pwd` -Icontrib -I../tcpcrypt/code/user ${CURL} -o test/test_http_tcpcrypt_auth test/test_http_tcpcrypt_auth.c  test/parser.c contrib/curl_http_kv_parser.c http_tcpcrypt_auth.c
